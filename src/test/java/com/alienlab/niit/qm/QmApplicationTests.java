...
import com.alienlab.niit.qm.service.impl.BaseTermServiceImpl;
...
public class QmApplicationTests {
	...
	public void contextLoads() throws Exception {
		...
		Page<BaseStudentEntity> getStudentByClassNo = baseStudentService.getStudentByClassNo("2014027501",new PageRequest(0,5));
		System.out.print(getStudentByClassNo);
